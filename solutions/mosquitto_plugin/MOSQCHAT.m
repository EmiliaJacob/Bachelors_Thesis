...
AUTH(clid,user,pass) ; liefert 0 zurueck falls authentifizierung erfolgreich verlief
	...
	quit 1
	;
ACL(clid,user,access,topic,payloadlen,payload,resp) ;; Die aktuellen Spools sind nur fuer request/response type situationen gedacht. Deshalb wird hier auch eine lokale Variabel verwendet. ;
